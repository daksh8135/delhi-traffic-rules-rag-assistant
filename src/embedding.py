...
def generate_embeddings(texts: list[str], model_name='paraphrase-multilingual-MiniLM-L12-v2') -> np.ndarray:
...
if __name__ == "__main__":
    # Now reads the MERGED chunk file (all PDFs combined) instead of one file
